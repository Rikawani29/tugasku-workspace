...
public class BiayaActivity extends Activity {
	...
	public void cekJawaban(View v){
		String jawabanBenar = "BIAYA RELOKASI";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), JejakaActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.biaya, menu);
		return true;
	}
