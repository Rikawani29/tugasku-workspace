...
public class PenyuActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_penyu);
	...
	public void cekJawaban(View v){
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent i = new Intent (getApplicationContext(), PerangActivity.class);
			startActivity(i);
		}
		else{
			//pesan toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.penyu, menu);
		return true;
	}
