...
public class PerangActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_perang);
	...
	public void cekJawaban(View v){
		String jawabanBenar = "PERANGKO KILAT";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.perang, menu);
		return true;
	}
